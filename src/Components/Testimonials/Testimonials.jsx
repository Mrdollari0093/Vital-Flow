...
import { TestiHeader, TestiTitle, TestimonialsData } from "./TestimonialsData";
...
function Testimonials() {
  return (
    <div className="overflow-x-hidden bg-white">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-5 px-4 pb-10 md:grid-cols-2 md:px-6 md:pb-16 lg:grid-cols-3">
